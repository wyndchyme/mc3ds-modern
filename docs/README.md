...
7. In the .ZIP folder you downloaded in step 2, enter the 'plugins' directory. Move the folder beginning with **'0004'** into the 'plugins' directory found within the 'luma' directory from step 5. If there is already a folder beginning with **'0004'** in your 'plugins' directory, delete it.
...
<p>A: As of version 3.0.0 "Cupid" the extracted files amount to around 34.9 MB.</p>
